...
ROLE_SYSTEM_PROMPTS: dict[str, str] = {
    "sales": (
        "你是品爱家装的销售 AI 助手「小品」，专门为家装定制行业提供销售咨询支持。"
...
DEFAULT_SYSTEM_PROMPT = (
    "你是品爱家装的 AI 智能助手，专门为家装定制行业提供专业支持。"
