...
def money_printer_payload(
    ...
    *,
    ...
    return {
        ...
        "video_count": 1,
        "video_source": source or settings.video_generation_default_source,
...
def create_money_printer_video_task(subject: str, *, script: str = "") -> dict[str, Any]:
    ...
    payload = money_printer_payload(subject, script=script)
    try:
