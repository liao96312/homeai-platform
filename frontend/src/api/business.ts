...
export const businessApi = {
  ...
  analyzeTradeInquiry: (payload: ApiPayload) => request('/api/trade/inquiries/analyze', { method: 'POST', body: JSON.stringify(payload) }),
  draftTradeQuote: (payload: ApiPayload) => request('/api/trade/quotes/draft', { method: 'POST', body: JSON.stringify(payload) }),
  draftTradeFollowup: (payload: ApiPayload) => request('/api/trade/followups/draft', { method: 'POST', body: JSON.stringify(payload) }),
